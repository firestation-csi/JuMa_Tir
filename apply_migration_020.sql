-- Migration 020: Admin User Credentials für Passkey-Support
-- Diese Migration muss in der Datenbank ausgeführt werden
...
SELECT 'Migration 020 erfolgreich angewendet' as status;