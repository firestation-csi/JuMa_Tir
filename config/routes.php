...
return [
    'GET' => [
        ...
        '/api/admin/groups/locations'         => ['App\Controller\AdminGroupController', 'liveLocations'],
        '/api/admin/groups/{id}/location-history' => ['App\Controller\AdminGroupController', 'locationHistory'],
    ...
    'POST' => [
        ...
        '/api/group/announcements'       => ['App\Controller\GroupInfoController', 'announcements'],
        ...
        '/admin/announcements'                                   => ['App\Controller\AdminAnnouncementController', 'store'],
        '/admin/announcements/{id}/delete'                       => ['App\Controller\AdminAnnouncementController', 'delete'],
